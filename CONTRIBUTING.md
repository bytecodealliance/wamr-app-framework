Contributing to WAMR-APP-FRAMEWORK
=====================
...
use, modify, distribute and sell your own products based on WAMR-APP_FRAMEWORK.
...
Report bugs
===================
We use GitHub issues to track public bugs. Report a bug by [open a new issue](https://github.com/bytecodealliance/wamr-app-framework/issues/new).

Code of Conduct
===============

WAMR-APP-FRAMEWORK is a [Bytecode Alliance](https://bytecodealliance.org/) project, and follows the Bytecode Alliance's [Code of Conduct](CODE_OF_CONDUCT.md) and [Organizational Code of Conduct](ORG_CODE_OF_CONDUCT.md).
